...
const TESTIMONIALS_DATA = [
  {
    image: img1,
    heading: 'Kinnect.us',
    designation: '30/10/2020 - present',
    content:
      'Working as a Software developer . My areas of responsibility includes primarily front-end software development, analyzing user stores, proposing solutions and coordinating with the test and product teams.',
  },
  {
    image: img2,
    heading: 'Givebrite.com',
    designation: '01/12/2020 - present',
    content:
      'Freelance Frontend developer responsible for creating reusable components and managing the workflow as well as developing intuitive user Interface.',
  },
  {
    image: img3,
    heading: 'Zersey Infotech',
    designation: '1/06/2019 - 1/08/2019',
    content:
      'Worked with the core Product development team and Responsible for Angular Application Development.',
  },
